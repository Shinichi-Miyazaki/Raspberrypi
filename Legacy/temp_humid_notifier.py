...
# Slackトークンは環境変数から取得する（コードに直書きするとGitHubのpush保護で拒否されるため）
SLACK_TOKEN = os.environ.get('SLACK_TOKEN', '')                   # Slack Bot User OAuth Token
SLACK_CHANNEL = '#246temperature_humidity_notifier'                 # チャンネル名（"#xxxx" もしくは "CXXXXXXXX"）
channel_id = 'C08AS5KDWH0'                    # ファイル送信時に使う場合セットしておく
TEMP_MAX = 23
TEMP_MIN = 17
HUMIDITY_MAX = 70
HUMIDITY_MIN = 40
...
SAVE_DIR = '/home/harry.one/Desktop/data'
